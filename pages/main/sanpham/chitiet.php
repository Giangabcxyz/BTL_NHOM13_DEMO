...
<?php 
      $sql_get_data = "SELECT * FROM  sanpham WHERE sanpham.id_sanpham = '$_GET[id]' ";
      $sql = mysqli_query($conn,$sql_get_data);
      while ($row = mysqli_fetch_array($sql)){
?>
<form action="pages/main/giohang.php?page=themgh&id=<?php echo $row['id_sanpham']?>" method="POST">
    <div id="productNotFound" style="min-height: 50vh; text-align: center; margin: 50px; display: none;">
            ...
            <div class="chitietSanpham" style="margin-bottom: 100px">
                ...
                <div class="rowdetail group">
                    <div class="picture">
                        <img src="admincp/modules/quanlysanpham/uploads/<?php echo $row['hinhanh'] ?>" onclick="opencertain()">
                    </div>
                    <div class="price_sale">
                        ...
                        <div class="area_promo">
                            ...
                            <div class="promo">
                                ...
                                <div id="detailPromo"><?php echo $row['khuyenmai'] ?></div>
                            </div>
                        </div>
                        <div class="policy">
                            <div>
                        ...
                        <div class="area_order">
                            ...
                            <a class="buy_now" onclick="themVaoGioHang(maProduct, nameProduct);">
                                ...
                                <b><i class="fa fa-cart-plus"></i> <input type="submit" style="background-color: none;" name="themgh" value="Thêm vào giỏ hàng"> </b>
